...
-- Equation(s):
-- \y~0_combout\ = (\s~combout\(1) & ((\d2~combout\(0)) # ((\s~combout\(0))))) # (!\s~combout\(1) & (((!\s~combout\(0) & \d0~combout\(0)))))
...
-- Equation(s):
-- \y~1_combout\ = (\y~0_combout\ & (((\d3~combout\(0)) # (!\s~combout\(0))))) # (!\y~0_combout\ & (\d1~combout\(0) & (\s~combout\(0))))
...
-- Equation(s):
-- \y~2_combout\ = (\s~combout\(0) & (((\s~combout\(1)) # (\d1~combout\(1))))) # (!\s~combout\(0) & (\d0~combout\(1) & (!\s~combout\(1))))
...
-- Equation(s):
-- \y~3_combout\ = (\y~2_combout\ & (((\d3~combout\(1)) # (!\s~combout\(1))))) # (!\y~2_combout\ & (\d2~combout\(1) & (\s~combout\(1))))
...
-- Equation(s):
-- \y~4_combout\ = (\s~combout\(1) & (((\s~combout\(0)) # (\d2~combout\(2))))) # (!\s~combout\(1) & (\d0~combout\(2) & (!\s~combout\(0))))
...
-- Equation(s):
-- \y~5_combout\ = (\s~combout\(0) & ((\y~4_combout\ & ((\d3~combout\(2)))) # (!\y~4_combout\ & (\d1~combout\(2))))) # (!\s~combout\(0) & (\y~4_combout\))
...
-- Equation(s):
-- \y~6_combout\ = (\s~combout\(0) & (((\s~combout\(1)) # (\d1~combout\(3))))) # (!\s~combout\(0) & (\d0~combout\(3) & (!\s~combout\(1))))
...
-- Equation(s):
-- \y~7_combout\ = (\s~combout\(1) & ((\y~6_combout\ & (\d3~combout\(3))) # (!\y~6_combout\ & ((\d2~combout\(3)))))) # (!\s~combout\(1) & (((\y~6_combout\))))
