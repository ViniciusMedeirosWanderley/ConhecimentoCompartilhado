...
ARCHITECTURE structure OF mux2_estruturado IS
...
SIGNAL \t1|y[0]~0_combout\ : std_logic;
SIGNAL \t1|y[1]~1_combout\ : std_logic;
SIGNAL \t1|y[2]~2_combout\ : std_logic;
SIGNAL \t1|y[3]~3_combout\ : std_logic;
...
\t1|y[0]~0\ : cycloneii_lcell_comb
-- Equation(s):
-- \t1|y[0]~0_combout\ = (\s~combout\ & ((\d1~combout\(0)))) # (!\s~combout\ & (\d0~combout\(0)))
...
\t1|y[1]~1\ : cycloneii_lcell_comb
-- Equation(s):
-- \t1|y[1]~1_combout\ = (\s~combout\ & (\d1~combout\(1))) # (!\s~combout\ & ((\d0~combout\(1))))
...
\t1|y[2]~2\ : cycloneii_lcell_comb
-- Equation(s):
-- \t1|y[2]~2_combout\ = (\s~combout\ & ((\d1~combout\(2)))) # (!\s~combout\ & (\d0~combout\(2)))
...
\t1|y[3]~3\ : cycloneii_lcell_comb
-- Equation(s):
-- \t1|y[3]~3_combout\ = (\s~combout\ & (\d1~combout\(3))) # (!\s~combout\ & ((\d0~combout\(3))))
